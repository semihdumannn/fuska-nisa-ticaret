class TurkishCities {
  ...
  static const Map<String, List<String>> data = {
    ...
    'Balıkesir': ['Altıeylül','Ayvalık','Balya','Bandırma','Bigadiç','Burhaniye','Dursunbey','Edremit','Erdek','Gömeç','Gönen','İvrindi','Karesi','Kepsut','Manyas','Marmara','Savaştepe','Sındırgı','Susurluk'],
    ...
    'Kastamonu': ['Abana','Ağlı','Araç','Azdavay','Bozkurt','Çatalzeytin','Cide','Çavuşlu','Daday','Devrekani','Doğanyurt','Hanönü','İhsangazi','İnebolu','Küre','Merkez','Pınarbaşı','Seydiler','Şenpazar','Taşköprü','Tosya'],
    ...
    'Malatya': ['Akçadağ','Arguvan','Battalgazi','Darende','Doğanşehir','Doğanyol','Hekimhan','Kale','Kuluncak','Pütürge','Yazıhan','Yeşilyurt'],
  ...
  static List<String> get cities => data.keys.toList()..sort();
